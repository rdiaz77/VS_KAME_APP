...
CSV_PATH = "test/pagar/clean/cuentas_por_pagar_clean.csv"
TABLE_NAME = "cta_por_pagar"
LOG_PATH = "data/inventory_db_load.log"


def create_cta_por_pagar_table():
    logs = []
    start_time = datetime.now()
    logs.append(
        f"=== INVENTORY DB LOAD LOG === {start_time.strftime('%Y-%m-%d %H:%M:%S')}\n"
    )
    ...
    try:
        ...
        # Load cleaned data
        print("📦 Loading cleaned cuenta por pagar CSV...")
